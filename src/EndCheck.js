export function CheckEnd(last_ind,marker,board){ //will use this for a win condition/draw condition
    ...
    if (last_ind == 0 || last_ind == 3 || last_ind == 6){
      ...
      if (board[last_ind-1] == marker && board[last_ind+1] == marker){
        ...
        if ((board[0] == marker && board[8] == marker) || (board[2] == marker && board[6] == marker) || (board[1] == marker && board[7]==marker)){
          console.log("We have a winner!")
          return(1);
        }
